                    ...
                    success: function (data) {
                        ...
                        if (isValid) {
                            ...
                            dataTable.row(tableRow).data([
                                ...
                                commentUpdateAjaxModel.CommentDto.Comment.CommentContent.length > 75 ? commentUpdateAjaxModel.CommentDto.Comment.CommentContent.substring(0, 75) : commentUpdateAjaxModel.CommentDto.Comment.CommentContent,
                        ...
                        success: function (data) {
                            ...
                            if (commentResult.Data) {
                                dataTable.row(tableRow).data([
                                    ...
                                    commentResult.Data.Comment.CommentContent.length > 75 ? commentResult.Data.Comment.CommentContent.substring(0, 75) : commentResult.Data.Comment.CommentContent,
